...
public class EmojiDetailsDialogFragment extends DialogFragment {
    ...
    private void fillDialog(View mainView){
        ...
        //region setsShareButton
        Button shareButton = (Button) mainView.findViewById(R.id.emoji_share_buton);
        shareButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sendIntent = new Intent();
                sendIntent.setAction(Intent.ACTION_SEND);
                sendIntent.putExtra(Intent.EXTRA_TEXT, emoji.getUnicodeProper());
